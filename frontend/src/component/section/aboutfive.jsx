...
class AboutSectionFive extends Component {
  render() {
    return (
      <div
        className="about about--style4 padding-top padding-bottom bg_img"
        ...
        <div className="container">
          ...
          <div className="section__wrapper">
            <div
              className="row g-4 justify-content-center row-cols-xl-4 row-cols-lg-3 row-cols-sm-2 row-cols-1 wow fadeInUp"
              data-wow-duration="1.5s">
            ...
            <div
              ...
              <a href={videoLink} className="default-btn" target="_blank">
                <span>
                  {btnText} <i className="fas fa-video"></i>
                </span>
              </a>
            </div>
          </div>
