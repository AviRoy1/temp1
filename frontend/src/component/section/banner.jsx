                        ...
                        <div className="col-12">
                          <div className="banner__inputlist">
                            <select id="country" name="country">
                              <option defaultValue="Bangladesh">
                                Bangladesh
                              </option>
                              <option defaultValue="Afganistan">
                                Afghanistan
                              </option>
                              ...
                              <option defaultValue="Antigua & Barbuda">
                                Antigua & Barbuda
                              </option>
                              <option defaultValue="Argentina">
                                Argentina
                              </option>
                              ...
                              <option defaultValue="Azerbaijan">
                                Azerbaijan
                              </option>
                              ...
                              <option defaultValue="British Indian Ocean Ter">
                              ...
                              <option defaultValue="Canary Islands">
                                Canary Islands
                              </option>
                              <option defaultValue="Cape Verde">
                                Cape Verde
                              </option>
                              ...
                              <option defaultValue="Channel Islands">
                                Channel Islands
                              </option>
                              ...
                              <option defaultValue="Cocos Island">
                                Cocos Island
                              </option>
                              ...
                              <option defaultValue="Costa Rica">
                                Costa Rica
                              </option>
                              <option defaultValue="Cote DIvoire">
                                Cote DIvoire
                              </option>
                              ...
                              <option defaultValue="French Southern Ter">
                                French Southern Ter
                              </option>
                              ...
                              <option defaultValue="Gibraltar">
                                Gibraltar
                              </option>
                              <option defaultValue="Great Britain">
                                Great Britain
                              </option>
                              <option defaultValue="Greece">Greece</option>
                              <option defaultValue="Greenland">
                                Greenland
                              </option>
                              <option defaultValue="Grenada">Grenada</option>
                              <option defaultValue="Guadeloupe">
                                Guadeloupe
                              </option>
                              <option defaultValue="Guam">Guam</option>
                              <option defaultValue="Guatemala">
                                Guatemala
                              </option>
                              ...
                              <option defaultValue="Isle of Man">
                                Isle of Man
                              </option>
                              ...
                              <option defaultValue="Kazakhstan">
                                Kazakhstan
                              </option>
                              ...
                              <option defaultValue="Korea Sout">
                                Korea South
                              </option>
                              <option defaultValue="Kuwait">Kuwait</option>
                              <option defaultValue="Kyrgyzstan">
                                Kyrgyzstan
                              </option>
                              ...
                              <option defaultValue="Lithuania">
                                Lithuania
                              </option>
                              <option defaultValue="Luxembourg">
                                Luxembourg
                              </option>
                              <option defaultValue="Macau">Macau</option>
                              <option defaultValue="Macedonia">
                                Macedonia
                              </option>
                              <option defaultValue="Madagascar">
                                Madagascar
                              </option>
                              ...
                              <option defaultValue="Martinique">
                                Martinique
                              </option>
                              <option defaultValue="Mauritania">
                                Mauritania
                              </option>
                              <option defaultValue="Mauritius">
                                Mauritius
                              </option>
                              <option defaultValue="Mayotte">Mayotte</option>
                              <option defaultValue="Mexico">Mexico</option>
                              <option defaultValue="Midway Islands">
                                Midway Islands
                              </option>
                              ...
                              <option defaultValue="Montserrat">
                                Montserrat
                              </option>
                              <option defaultValue="Morocco">Morocco</option>
                              <option defaultValue="Mozambique">
                                Mozambique
                              </option>
                              ...
                              <option defaultValue="Netherland Antilles">
                                Netherland Antilles
                              </option>
                              ...
                              <option defaultValue="New Zealand">
                                New Zealand
                              </option>
                              <option defaultValue="Nicaragua">
                                Nicaragua
                              </option>
                              ...
                              <option defaultValue="Palau Island">
                                Palau Island
                              </option>
                              <option defaultValue="Palestine">
                                Palestine
                              </option>
                              ...
                              <option defaultValue="Phillipines">
                                Philippines
                              </option>
                              ...
                              <option defaultValue="Republic of Montenegro">
                                Republic of Montenegro
                              </option>
                              <option defaultValue="Republic of Serbia">
                                Republic of Serbia
                              </option>
                              ...
                              <option defaultValue="St Barthelemy">
                                St Barthelemy
                              </option>
                              <option defaultValue="St Eustatius">
                                St Eustatius
                              </option>
                              <option defaultValue="St Helena">
                                St Helena
                              </option>
                              <option defaultValue="St Kitts-Nevis">
                                St Kitts-Nevis
                              </option>
                              <option defaultValue="St Lucia">St Lucia</option>
                              <option defaultValue="St Maarten">
                                St Maarten
                              </option>
                              <option defaultValue="St Pierre & Miquelon">
                                St Pierre & Miquelon
                              </option>
                              <option defaultValue="St Vincent & Grenadines">
                                St Vincent & Grenadines
                              </option>
                              <option defaultValue="Saipan">Saipan</option>
                              <option defaultValue="Samoa">Samoa</option>
                              <option defaultValue="Samoa American">
                                Samoa American
                              </option>
                              <option defaultValue="San Marino">
                                San Marino
                              </option>
                              ...
                              <option defaultValue="Seychelles">
                                Seychelles
                              </option>
                              <option defaultValue="Sierra Leone">
                                Sierra Leone
                              </option>
                              <option defaultValue="Singapore">
                                Singapore
                              </option>
                              ...
                              <option defaultValue="Tajikistan">
                                Tajikistan
                              </option>
                              ...
                              <option defaultValue="Trinidad & Tobago">
                                Trinidad & Tobago
                              </option>
                              ...
                              <option defaultValue="Turks & Caicos Is">
                                Turks & Caicos Is
                              </option>
                              ...
                              <option defaultValue="United Arab Erimates">
                              ...
                              <option defaultValue="Uzbekistan">
                                Uzbekistan
                              </option>
                              <option defaultValue="Vanuatu">Vanuatu</option>
                              <option defaultValue="Vatican City State">
                                Vatican City State
                              </option>
                              <option defaultValue="Venezuela">
                                Venezuela
                              </option>
                              <option defaultValue="Vietnam">Vietnam</option>
                              <option defaultValue="Virgin Islands (Brit)">
                                Virgin Islands (Brit)
                              </option>
                              <option defaultValue="Virgin Islands (USA)">
                                Virgin Islands (USA)
                              </option>
                              <option defaultValue="Wake Island">
                                Wake Island
                              </option>
                              <option defaultValue="Wallis & Futana Is">
                                Wallis & Futana Is
                              </option>
