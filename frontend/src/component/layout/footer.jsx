...
import { newsLetterSignUp } from "../../apis/NewsLetterRequest";
import { toast, ToastContainer } from "react-toastify";
import img1 from "../../css/assets/images/footer/bg-3.jpg";
...
class Footer extends Component {
  ...
  handleSubscribeClick = async (e) => {
    e.preventDefault();
    try {
      const result = await newsLetterSignUp({ email: this.state.newsEmail });
